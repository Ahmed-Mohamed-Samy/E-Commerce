...
namespace E_Commerce.Persistence.Data.Migrations
{
    ...
    [Migration("20251203210715_OrderModulesTables")]
    partial class OrderModulesTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("E_Commerce.Domain.Entities.OrderModule.Order", b =>
                {
                    ...
                    b.Property<int>("DelviryMethodId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Commerce.Domain.Entities.OrderModule.OrderItem", b =>
                {
                    ...
                    b.OwnsOne("E_Commerce.Domain.Entities.OrderModule.ProductItemOrder", "Product", b1 =>
                        {
